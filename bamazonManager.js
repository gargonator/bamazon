						...
						inquirer.prompt([{
							...
							inquirer.prompt([{
								...
								inquirer.prompt([{
									...
									if (typeof item_id != 'number' || typeof price != 'number' || typeof stock_quantity != 'number'
												|| typeof product_name != 'string' typeof department_name != 'string') {
										console.log('\nYour inputs are not in the right format. Try again.')
									}
									}
									console.log(item_id,product_name,department_name,price,answer.quantity);
								})
							})
						})
					})
